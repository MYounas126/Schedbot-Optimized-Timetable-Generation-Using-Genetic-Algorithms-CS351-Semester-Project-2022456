...
def query_openai(prompt):
    load_dotenv()
    openai_api_key = os.getenv("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")
    client = OpenAI(
